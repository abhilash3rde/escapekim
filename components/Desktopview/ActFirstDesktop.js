  ...
  return (
    ...
    <div className='font-classic overflow-hidden' >
      <div className="bg-[url('/DesktopImages/background_02.jpg')] h-[100%] bg-cover bg-no-repeat bg-fixed  " >
        ...
        <div className=' relative flex  justify-between w-[100%] gap-1' ref={cloud.ref}  >
          <div className='grid grid-cols-2 w-[100%]'>
            ...
            <div className='flex justify-start items-center '>
              <img src={'DesktopImages/silhouette-dude@2x.png'} alt="" className='h-[62px] w-[66px] z-50 absolute left-[47%]' />
            </div>
          </div>
          ...
          <div className=' w-[80%] ' >
            <div ref={parallax0.ref} className='duration-300'>
              <div className=' relative flex  grid grid-cols-1 ' >
                <img src={'/DesktopImages/cs01.png'} alt="" className='w-full h-[362px] z-50   duration-500 ' ref={parallax.ref} />

                <div className=' flex justify-center ' >
                  <div className='w-[80%] grid  grid-cols-2 absolute  top-[-20px] z-50 duration-[1000ms]' ref={text1.ref} >
                ...
                <div className=' flex justify-center '>
                  <div className='w-[95%] grid  grid-cols-2 absolute  top-[28px] duration-[1000ms] z-50' ref={text2.ref} >
                ...
                <div className=' flex justify-center '>
                  <div className='w-[95%] grid  grid-cols-2 absolute  top-[76px] z-50 duration-[1000ms]' ref={text3.ref}>
            ...
            <div className=' relative flex justify-center mt-6 duration-400'>
              <div className='w-[90%] grid  grid-cols-1 ' >
                <img src={'/DesktopImages/cs-jump02.png'} alt="" className='h-[268px]  ' ref={parallax1.ref} />

                <div className=' flex justify-center '>
                  <div className='w-[95%] grid  grid-cols-2 absolute  top-[3px] z-50 duration-[1000ms]' ref={text5.ref}>
                ...
                <div className='my-2  flex justify-center '>
                  <div className='w-[80%] grid  grid-cols-2 absolute  top-[50px] z-50  duration-[1000ms]' ref={text6.ref}>
                ...
                <div className=' flex justify-center '>
                  <div className='w-[95%] grid  grid-cols-2 absolute  top-[95px]  z-50 duration-[1000ms]' ref={text7.ref}>
                ...
                <div className=' absolute top-[9.6875rem] right-0 z-50 duration-[800ms]' ref={text8.ref}>
                  <div className=''>
                ...
                <div className=' absolute top-[14.6rem] right-0  z-50 duration-[800ms]' ref={text9.ref} >
                  <div className=''>
            ...
            <div className='mb-2  ' >
              <div className='w-[100%] grid   grid-cols-4 mt-4  duration-[800ms] z-50 '>
                <div ref={text10.ref} className=' col-start-6 px-2 py-2 h-[2.625rem]  w-[17.3125rem]  justify-end z-50 border-[#070707]  items-center bg-[#FFE5A3] border-2 opacity-1  flex  flex-nowrap '>
            ...
            <div className=' relative flex  grid grid-cols-1 duration-500 ' ref={parallax3.ref}>
        ...
        <div className='grid  grid-cols-1  duration-200 ' ref={parallax4.ref}>
        ...
        <div className='relative flex justify-center items-center w-[100%]' >
          ...
          <div className='absolute bottom-[105px] grid w-[80%] grid-cols-3 duration-[1000ms] z-50' ref={text11.ref}>
